# -*- coding: utf-8 -*-
"""
Created on Thu Jul 12 05:51:03 2018
...
# Loading the data
preictal_addr = '/media/amankumar/Pro/BCI project/processed_dataset/band_pass_filtered/chb01/'
folder_names = ['preictal']
...
np.savetxt('/media/amankumar/Pro/BCI project/processed_dataset/band_pass_filtered/chb01/bpf_preictal_feature_data.csv',
           preictal_feature_data,fmt = '%f', delimiter = ',')



interictal_addr = '/media/amankumar/Pro/BCI project/processed_dataset/band_pass_filtered/chb01/interictal'
...
# saving the dataset      
np.savetxt('/media/amankumar/Pro/BCI project/processed_dataset/band_pass_filtered/chb01/bpf_interictal_feature_data.csv',
