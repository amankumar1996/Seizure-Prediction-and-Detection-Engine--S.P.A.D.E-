# -*- coding: utf-8 -*-
"""
Created on Fri Jul 13 00:05:10 2018
...
preictal_feature_data = (pd.read_csv('/media/amankumar/Pro/BCI project/processed_dataset/CHB-MIT/chb01/filtered_preictal_feature_data2_5_50.csv',
                                    header = None)).as_matrix()

interictal_feature_data = (pd.read_csv('/media/amankumar/Pro/BCI project/processed_dataset/CHB-MIT/chb01/filtered_interictal_feature_data2_5_50.csv',
                                    header = None)).as_matrix()
